...
#											TODO													#
#####################################################################################################
# - Clean touch function.
# - Clean anything else that needs it.
...
var Falling_WallStablization = false
...
#															FUNCTIONS																			     #
######################################################################################################################################################
# InterpolateCamera( float, float, float, float )
	...
	if(is_on_floor() or is_on_wall() or is_on_ceiling()):
		...
		# Ray cast down from center of player.
			...
			if(Ray_Result):
				...
				#Go through the touched object list and see if objects are still being touched.
				var found = true
				var SlideCollisions = []
				SlideCollisions.resize(MaxSlides)
